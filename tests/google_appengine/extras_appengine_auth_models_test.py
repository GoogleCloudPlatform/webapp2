...
#
# import tests.google_appengine.test_base
...
#
#
# class TestAuthModels(tests.google_appengine.test_base.BaseTestCase):
#
#     def setUp(self):
...
#
#
# class TestUniqueModel(tests.google_appengine.test_base.BaseTestCase):
#     def setUp(self):
...
#     tests.google_appengine.test_base.main()
